...
ELSE(EXISTS PYQT4_VERSION)
  ...
  IF(pyqt_config)
    ...
    STRING(REGEX MATCH ".*\npyqt_sip_flags:([^\n]+).*$" _dummy ${pyqt_config})
    # Make sure cmake sees a list of arguments not a single string
    SEPARATE_ARGUMENTS(PYQT4_SIP_FLAGS WINDOWS_COMMAND ${CMAKE_MATCH_1})
    SET(PYQT4_SIP_FLAGS ${PYQT4_SIP_FLAGS} CACHE STRING "The SIP flags used to build PyQt4")
