...
#
# It contains a function parameterized by the major version of PyQt being
# searched.
#
# Search for the given version of PyQt. The function sets the following
# variables in the parent scope:
#
# PYQT${major_version}_VERSION - The version of PyQt found expressed as a 6
# digit hex number suitable for comparison as a string
#
# PYQT${major_version}_VERSION_STR - The version of PyQt as a human readable
# string.
#
# PYQT${major_version}_VERSION_TAG - The Qt version tag used by PyQt's sip
# files.
#
...
function(find_pyqt major_version)
  ...
  if(CMAKE_HOST_WIN32
     AND major_version EQUAL 4
     AND _pyqt_config_err MATCHES "Qt: Untested Windows version 10.0 detected!"
  )
  ...
  if(_pyqt_config AND NOT _pyqt_config_err)
    ...
    string(REGEX MATCH ".*\npyqt_sip_flags:([^\n]+).*$" _dummy ${_pyqt_config})
    string(REPLACE " " ";" _dummy ${CMAKE_MATCH_1})
  ...
  # Set the sip ABI used for the compiling PyQt. Required but the new sip-build
  # system
